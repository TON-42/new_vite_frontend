...
`telegram-web-app.js` is the script we load in our index.html to initialize the Telegram Mini App: https://core.telegram.org/bots/webapps#initializing-mini-apps
